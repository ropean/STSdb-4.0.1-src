...
namespace STSdb4.WaterfallTree
{
    public partial class WTree : IDisposable
    {
        ...
        /// The hook.
        /// </summary>
        public IDataContainer FindData(Locator originalLocator, Locator locator, IData key, Direction direction, out FullKey nearFullKey, out bool hasNearFullKey, ref FullKey lastVisitedFullKey)
        {
            if (disposed)
                throw new ObjectDisposedException("WTree");
