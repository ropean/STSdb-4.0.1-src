...
namespace STSdb4.Remote.Commands
{
    ...
    public class StorageEngineDatabaseSizeCommand : ICommand
    {
        public long Size;

        public StorageEngineDatabaseSizeCommand(long size)
        {
            Size = size;
        }

        public StorageEngineDatabaseSizeCommand()
            : this(0)
        {
        }
        ...
        public int Code
        {
            get { return CommandCode.STORAGE_ENGINE_DATABASE_SIZE; }
        }
    }
